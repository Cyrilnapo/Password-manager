...
namespace P_Secu_Gestionnaire_mdp
{
    public partial class Editing : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string deletePathRelatif = "../../../DATA/" + deleteSite;
            string deletePathComplet = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, deletePathRelatif);
            ...
            else if (File.Exists(cheminComplet) || File.Exists(deletePathComplet))
            {
            ...
            {
                Directory.Delete(deletePathComplet, true);
